...
If your new update is itself a rollout, the split changes. Your rollout percentage receives your update. Everyone else receives the update that was rolling out.
